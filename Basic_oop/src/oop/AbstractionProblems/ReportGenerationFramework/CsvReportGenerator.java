...
public class CsvReportGenerator extends ReportGenerator {
  ...
  protected String format(List<Record> records) {
    ...
    formatedString.append("--- CSV REPORT ---").append("\n");
    formatedString.append("Rows : ").append(records.size()).append("\n");
    formatedString.append("Data : ").append("\n");
    formatedString.append("--- HEADER ---");
    formatedString.append("ID, NAME, AGE, COUNTRY");
    for (Record record : records) {
      formatedString.append(record.getFieldId("id")).append(",");
      formatedString.append(record.getFieldId("name")).append(",");
      formatedString.append(record.getFieldId("age")).append(",");
      formatedString.append(record.getFieldId("country")).append(", \n");
    }
